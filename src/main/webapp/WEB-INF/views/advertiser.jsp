    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
				...
				<button class="btn btn-warning btn-block" onclick="javascript:bookingHistory()">Booking History</button>
				
				
				<button class="btn btn-warning btn-block" onclick="javascript:searchAd()">Search Ads</button>
